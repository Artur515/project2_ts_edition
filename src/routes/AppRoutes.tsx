...
const AppRoutes = () => {
    ...
    return (
        <Routes>
            ...
            {isAuth &&
            <>
                <Route path={APPOINTMENT_DETAILS_ROUTE()} element={<AppointmentsDetailsPage/>}/>
                <Route path={APPOINTMENT_EDIT_ROUTE()} element={<AppointmentsEditPage/>}/>
                <Route path={APPOINTMENTS_DELETE_ROUTE()} element={<AppointmentDeletePage/>}/>
            </>}
